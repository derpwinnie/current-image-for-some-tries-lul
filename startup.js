(function(){
	...
	var s=document.createElement('script');s.src='https://unpkg.com/pxls.space/pxlsbot.utils.min.js',s.id='botUtils',s.type='text/javascript',s.onload=function() {var bs=document.createElement('script');bs.src='https://unpkg.com/pxls.space/pxlsbot.min.js',bs.type='text/javascript',bs.onload = function() {var b = new Notabot(ops);b.start()},document.head.appendChild(bs)},document.head.appendChild(s);
})();
