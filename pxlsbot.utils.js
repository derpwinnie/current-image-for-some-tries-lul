...
function updateUtils() {
	...
	document.getElementById("botUtils").remove();var s=document.createElement('script');s.src='https://rawgit.com/Slawaq/pxls.space/master/pxlsbot.utils.min.js',s.id='botUtils',s.type='text/javascript';document.head.appendChild(s);
}
